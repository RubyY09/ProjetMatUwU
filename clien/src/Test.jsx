  ...
  return (
    ...
    <div className="flex   "> 
      <div className="w-115  ">
        ...
        <h2 className="text-gray-50 text-9xl BN  flex items-center">GAMES</h2>
      </div>
   ...
   <div className="flex flex-col gap-10 px-4 py-8 ms-5 me-5 mt-5 ">
    <div className="flex   ">
      <div className="w-115 ">
        ...
        <h2 className="text-gray-50 text-9xl BN  flex items-center">RECENT</h2>
      </div>
   ...
   <div className="flex flex-col gap-10 px-4 py-8 m-5  ">
    <div className="flex   ">
      <div className="w-115 ">
        ...
        <h2 className="text-gray-50 text-9xl BN  flex items-center">COURS</h2>
      </div>
